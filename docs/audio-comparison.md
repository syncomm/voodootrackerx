...
support, the minimal `PlaybackSong` adapter, and bounded adapted-segment render
helper remain offline-only and do not connect to runtime playback, parsed XM
envelopes, effects, or tempo-change data.
