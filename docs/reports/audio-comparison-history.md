# Audio Comparison History

This report archives older public-safe audio comparison notes that used to live
in `docs/audio-comparison.md`. It is retained for historical investigation
context and is not required reading for normal development sessions.

Use `docs/audio-comparison.md` for the current comparison workflow and
`docs/agent-current-state.md` for the current backend snapshot. Keep any future
long investigation reports out of the roadmap and workflow docs unless a
maintainer explicitly requests a committed public report.

## Archived Audio Reference Comparison
