...
final class VTXRenderBoundedXMTests: XCTestCase {
    ...
    func testDiagnosticsJSONIncludes6xyVibratoVolumeSlide() throws {
        ...
        XCTAssertEqual(summary["vibrato_volume_slide_6xy_volume_slide_applied"] as? Int, 5)
        ...
        XCTAssertEqual(summary["vibrato_volume_slide_6xy_scheduled_gain_update_count"] as? Int, 3)
        ...
        XCTAssertEqual(zero["effective_volume_after"] as? Int, 3)
        XCTAssertEqual(sameCell["active_voice_updated"] as? Bool, false)
        XCTAssertEqual(sameCell["effective_volume_before"] as? Int, 3)
        XCTAssertEqual(sameCell["effective_volume_after"] as? Int, 1)
        XCTAssertEqual(sameCellEvent["gain"] as? Double, 1.0 / 64.0)
