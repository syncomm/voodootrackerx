...
final class VTXRenderBoundedXMTests: XCTestCase {
    ...
    func testDiagnosticsJSONIncludes6xyVibratoVolumeSlide() throws {
        ...
        XCTAssertEqual(render["vibrato_volume_slide_6xy_scheduled_gain_update_count"] as? Int, 6)
        ...
        XCTAssertEqual(summary["vibrato_volume_slide_6xy_scheduled_gain_update_count"] as? Int, 6)
        ...
        XCTAssertEqual(sameCell["effective_volume_before"] as? Int, 0)
        XCTAssertEqual(sameCell["effective_volume_after"] as? Int, 0)
        XCTAssertEqual(sameCellEvent["gain"] as? Double, 0)
