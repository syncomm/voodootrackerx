...
STEMS_DESCRIPTION = "Sum local WAV stems and compare them to an optional full render."
...
def add_arguments(parser: argparse.ArgumentParser) -> None:
    """Add the authoritative stem diagnostic arguments to ``parser``."""
...
def build_argument_parser() -> argparse.ArgumentParser:
    """Build the standalone compatibility parser for stem diagnostics."""

    parser = argparse.ArgumentParser(description=STEMS_DESCRIPTION)
    add_arguments(parser)
    return parser


def parse_args(argv: list[str]) -> argparse.Namespace:
    """Parse standalone stem diagnostic arguments."""

    return build_argument_parser().parse_args(argv)


def run(args: argparse.Namespace) -> int:
    """Run stem diagnostics from parsed arguments."""
...
def main(argv: list[str]) -> int:
    """Run the standalone stem diagnostics CLI."""
