...
CORPUS_MAP_DESCRIPTION = (
    "Append private XM corpus labels, enrich local metadata, and write a redacted summary."
)


def add_arguments(parser: argparse.ArgumentParser) -> None:
    """Register corpus-map updater arguments on a standalone or unified parser."""
...
def build_argument_parser() -> argparse.ArgumentParser:
    """Build the standalone compatibility parser for corpus-map updates."""

    parser = argparse.ArgumentParser(description=CORPUS_MAP_DESCRIPTION)
    add_arguments(parser)
    return parser


def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    """Parse standalone corpus-map updater arguments."""
...
def run(args: argparse.Namespace) -> int:
    """Update a corpus map and write its public-safe summaries."""
