...
EFFECT_COVERAGE_DESCRIPTION = __doc__


def add_arguments(parser: argparse.ArgumentParser) -> None:
    """Register effect-coverage summary arguments on a standalone or unified parser."""
...
def build_argument_parser() -> argparse.ArgumentParser:
    """Build the standalone compatibility parser for effect-coverage summaries."""

    parser = argparse.ArgumentParser(description=EFFECT_COVERAGE_DESCRIPTION)
    add_arguments(parser)
    return parser


def parse_args(argv: list[str]) -> argparse.Namespace:
    """Parse standalone effect-coverage summary arguments."""

    return build_argument_parser().parse_args(argv)


def run(args: argparse.Namespace) -> int:
    """Run an effect-coverage summary from already-parsed arguments."""
