...
def normalize_key_off_events(diagnostics: dict[str, Any], rows: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    for raw_event in nested_list(diagnostics.get("key_off_events")):
        ...
        result.append({
            ...
            "effect_param": raw_event.get("effect_param"),
            "kxx_key_off": bool(raw_event.get("kxx_key_off")),
            "scheduled_frame": raw_event.get("scheduled_frame"),
            "synthetic_tick": raw_event.get("synthetic_tick"),
...
def add_arguments(parser: argparse.ArgumentParser) -> None:
    """Register correlation arguments on a standalone or unified parser."""
...
def build_argument_parser() -> argparse.ArgumentParser:
    """Build the standalone compatibility parser for correlation."""

    parser = argparse.ArgumentParser(description=CORRELATE_DESCRIPTION)
    add_arguments(parser)
    return parser


def parse_args(argv: list[str]) -> argparse.Namespace:
    """Parse standalone correlation arguments."""

    return build_argument_parser().parse_args(argv)


def run(args: argparse.Namespace) -> int:
    """Run correlation from already-parsed arguments."""
