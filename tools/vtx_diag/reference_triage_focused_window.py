...
FOCUSED_WINDOW_DESCRIPTION = __doc__


def add_arguments(parser: argparse.ArgumentParser) -> None:
    """Register focused-window arguments on a standalone or unified parser."""
...
def build_argument_parser() -> argparse.ArgumentParser:
    """Build the standalone compatibility parser for focused-window triage."""

    parser = argparse.ArgumentParser(description=FOCUSED_WINDOW_DESCRIPTION)
    add_arguments(parser)
    return parser


def parse_args(argv: list[str]) -> argparse.Namespace:
    """Parse standalone focused-window arguments."""

    return build_argument_parser().parse_args(argv)


def run(args: argparse.Namespace) -> int:
    """Run focused-window triage from already-parsed arguments."""
