...
RESIDUAL_SCAN_DESCRIPTION = __doc__


def add_arguments(parser: argparse.ArgumentParser) -> None:
    """Register residual-scan arguments on a standalone or unified parser."""
...
def build_argument_parser() -> argparse.ArgumentParser:
    """Build the standalone compatibility parser for residual scans."""

    parser = argparse.ArgumentParser(description=RESIDUAL_SCAN_DESCRIPTION)
    add_arguments(parser)
    return parser


def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    """Parse standalone residual-scan arguments."""

    return build_argument_parser().parse_args(argv)


def run(args: argparse.Namespace) -> int:
    """Run a residual scan from already-parsed arguments."""
