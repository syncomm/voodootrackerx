...
CORRELATE_WINDOW_DESCRIPTION = "Correlate runtime/offline C mixer mismatch windows."


def add_arguments(parser: argparse.ArgumentParser) -> None:
    """Register runtime/offline window arguments on a standalone or unified parser."""
...
def build_argument_parser() -> argparse.ArgumentParser:
    """Build the standalone compatibility parser for window correlation."""

    parser = argparse.ArgumentParser(description=CORRELATE_WINDOW_DESCRIPTION)
    add_arguments(parser)
    return parser


def parse_args(argv: list[str]) -> argparse.Namespace:
    """Parse standalone runtime/offline window arguments."""

    return build_argument_parser().parse_args(argv)


def run(args: argparse.Namespace) -> int:
    """Run window correlation from already-parsed arguments."""
